Pod::Spec.new do |s|
  ...
  s.source   = { :git => 'https://github.com/darrenallen7/TPKeyboardAvoiding.git', :tag => '1.2.7' }
  ...
  s.description = "This is a relatively universal, drop-in solution: UIScrollView and UITableView subclasses that handle everything." \
                    ...
                    "This is a fork of https://github.com/michaeltyson/TPKeyboardAvoiding.git that fixes issue #155"
